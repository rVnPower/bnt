...
var app = (function () {
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			img1 = element("img");
    			t3 = space();
    			if (!src_url_equal(img0.src, img0_src_value = "assets/trash.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "D");
    		...
    		a: function animate() {
    			stop_animation();
    			stop_animation = create_animation(div4, rect, flip, { duration: flipDurationMs });
    		},
    		d: function destroy(detaching) {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div0, "consider", /*handleConsider*/ ctx[1], false, false, false),
    					listen_dev(div0, "finalize", /*handleFinalize*/ ctx[2], false, false, false)
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => console.log("remove");
    	const click_handler_1 = () => console.log("asd");
    	...
    	return [items, handleConsider, handleFinalize, onDrop, click_handler, click_handler_1];
    }
    ...
    class Buttons extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*items*/ ctx[0] === undefined && !('items' in props)) {
    			console_1.warn("<Buttons> was created without expected prop 'items'");
    		}

    		if (/*onDrop*/ ctx[3] === undefined && !('onDrop' in props)) {
    			console_1.warn("<Buttons> was created without expected prop 'onDrop'");
    		}
    	}
