...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 20, 0, 436);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/components/Service.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 11, 8, 180);
    			add_location(p, file$4, 14, 8, 270);
    			attr_dev(div, "class", "button svelte-l6mapv");
    			add_location(div, file$4, 10, 4, 151);
    			attr_dev(a, "href", /*url*/ ctx[1]);
    			add_location(a, file$4, 9, 0, 130);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/settings/Form.svelte generated by Svelte v3.48.0 */

    const file$3 = "src/components/settings/Form.svelte";

    // (18:2) {#if state === "addition"}
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			h41 = element("h4");
    			h41.textContent = "Icon path";
    			t4 = space();
    			input1 = element("input");
    			t5 = space();
    			h42 = element("h4");
    			h42.textContent = "Link";
    			t7 = space();
    			input2 = element("input");
    			t8 = space();
    			h43 = element("h4");
    			h43.textContent = "Icon width";
    			t10 = space();
    			input3 = element("input");
    			t11 = space();
    			h44 = element("h4");
    			h44.textContent = "Icon height";
    			t13 = space();
    			input4 = element("input");
    			add_location(h40, file$3, 18, 4, 349);
    			add_location(input0, file$3, 19, 4, 367);
    			add_location(h41, file$3, 20, 4, 403);
    			add_location(input1, file$3, 21, 4, 426);
    			add_location(h42, file$3, 22, 4, 465);
    			add_location(input2, file$3, 23, 4, 483);
    			add_location(h43, file$3, 24, 4, 518);
    			add_location(input3, file$3, 25, 4, 542);
    			add_location(h44, file$3, 26, 4, 579);
    			add_location(input4, file$3, 27, 4, 604);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*item*/ 1 && input1.value !== /*item*/ ctx[0].iconUrl) {
    				set_input_value(input1, /*item*/ ctx[0].iconUrl);
    			}

    			if (dirty & /*item*/ 1 && input2.value !== /*item*/ ctx[0].url) {
    				set_input_value(input2, /*item*/ ctx[0].url);
    			}

    			if (dirty & /*item*/ 1 && input3.value !== /*item*/ ctx[0].iconW) {
    				set_input_value(input3, /*item*/ ctx[0].iconW);
    			}

    			if (dirty & /*item*/ 1 && input4.value !== /*item*/ ctx[0].iconH) {
    				set_input_value(input4, /*item*/ ctx[0].iconH);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*state*/ ctx[1] === "addition" && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "confirm svelte-po65ow");
    			add_location(button, file$3, 29, 2, 647);
    			add_location(form, file$3, 16, 0, 269);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function handleSubmit() {
    		if (item.iconUrl == undefined) {
    			$$invalidate(0, item.iconUrl = "assets/default-icon.png", item);
    			$$invalidate(0, item.iconW = "25", item);
    			$$invalidate(0, item.iconH = "40", item);
    		}

    		save(item);
    	}

    	const writable_props = ['state', 'item', 'save'];
    	...
    	function input3_input_handler() {
    		item.iconW = this.value;
    		$$invalidate(0, item);
    	}

    	function input4_input_handler() {
    		item.iconH = this.value;
    		$$invalidate(0, item);
    	}
    	...
    	$$self.$capture_state = () => ({ state, item, save, handleSubmit });
    ...
    class Form extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { state: 1, item: 0, save: 3 });
    		...
    		if (/*state*/ ctx[1] === undefined && !('state' in props)) {
    			console.warn("<Form> was created without expected prop 'state'");
    		}

    		if (/*item*/ ctx[0] === undefined && !('item' in props)) {
    			console.warn("<Form> was created without expected prop 'item'");
    		}

    		if (/*save*/ ctx[3] === undefined && !('save' in props)) {
    			console.warn("<Form> was created without expected prop 'save'");
    		}
    	}
    ...
    // (56:8) {#each items as item(item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(img0, file$2, 61, 28, 1487);
    			attr_dev(div0, "class", "delete svelte-5jk2ej");
    			add_location(div0, file$2, 60, 24, 1402);
    			...
    			add_location(img1, file$2, 64, 28, 1686);
    			attr_dev(div1, "class", "edit svelte-5jk2ej");
    			add_location(div1, file$2, 63, 24, 1603);
    			attr_dev(div2, "class", "tray svelte-5jk2ej");
    			add_location(div2, file$2, 59, 20, 1359);
    			attr_dev(div3, "class", "card svelte-5jk2ej");
    			add_location(div3, file$2, 57, 16, 1288);
    			add_location(div4, file$2, 56, 12, 1225);
    			this.first = div4;
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*handleRemoval*/ ctx[5](/*item*/ ctx[10].name))) /*handleRemoval*/ ctx[5](/*item*/ ctx[10].name).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(56:8) {#each items as item(item.id)}",
    		ctx
    	});
    ...
    // (79:0) {#if state === "addition"}
    function create_if_block$1(ctx) {
    	let buttonsform;
    	let current;

    	buttonsform = new Form({
    			props: {
    				state: /*state*/ ctx[1],
    				item: {},
    				save: /*handleAddition*/ ctx[4]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			create_component(buttonsform.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(buttonsform, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const buttonsform_changes = {};
    			if (dirty & /*state*/ 2) buttonsform_changes.state = /*state*/ ctx[1];
    			buttonsform.$set(buttonsform_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(buttonsform.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(buttonsform.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(buttonsform, detaching);
    		}
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	let if_block = /*state*/ ctx[1] === "addition" && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 50, 4, 1018);
    			attr_dev(div1, "class", "card add svelte-5jk2ej");
    			add_location(div1, file$2, 72, 8, 1890);
    			add_location(div2, file$2, 71, 4, 1876);
    			attr_dev(section, "class", "svelte-5jk2ej");
    			add_location(section, file$2, 49, 0, 1004);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div0, "consider", /*handleConsider*/ ctx[2], false, false, false),
    					listen_dev(div0, "finalize", /*handleFinalize*/ ctx[3], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*console, handleRemoval, items*/ 33) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['items', 'save'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Buttons> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => console.log("asd");
    	const click_handler_1 = () => $$invalidate(1, state = "addition");
    ...
    class Buttons extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { items: 0, save: 6 });
    		...
    		if (/*save*/ ctx[6] === undefined && !('save' in props)) {
    			console_1.warn("<Buttons> was created without expected prop 'save'");
    		}
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 25, 0, 593);
    			add_location(h30, file$1, 28, 4, 657);
    			add_location(input0, file$1, 29, 4, 676);
    			attr_dev(span0, "class", "confirm button");
    			add_location(span0, file$1, 30, 4, 718);
    			add_location(hr, file$1, 38, 4, 885);
    			add_location(h31, file$1, 40, 4, 919);
    			attr_dev(a, "href", "https://github.com/rvnpower/bnt/README.md#bg");
    			add_location(a, file$1, 41, 11, 956);
    			add_location(small, file$1, 41, 4, 949);
    			add_location(input1, file$1, 42, 4, 1043);
    			attr_dev(span1, "class", "confirm button");
    			add_location(span1, file$1, 43, 4, 1087);
    			add_location(h32, file$1, 52, 4, 1310);
    			attr_dev(div, "class", "settings svelte-4jtqvx");
    			add_location(div, file$1, 26, 0, 611);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
