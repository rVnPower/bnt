...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 20, 0, 436);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/components/Service.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 11, 8, 180);
    			add_location(p, file$3, 14, 8, 270);
    			attr_dev(div, "class", "button svelte-l6mapv");
    			add_location(div, file$3, 10, 4, 151);
    			attr_dev(a, "href", /*url*/ ctx[1]);
    			add_location(a, file$3, 9, 0, 130);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/settings/Buttons.svelte generated by Svelte v3.48.0 */
    const file$2 = "src/components/settings/Buttons.svelte";
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "svelte-amvc1g");
    			add_location(div, file$2, 18, 8, 469);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*items*/ 1 && t0_value !== (t0_value = /*item*/ ctx[4].name + "")) set_data_dev(t0, t0_value);
    		},
    		r: function measure() {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:4) {#each items as item(item.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-amvc1g");
    			add_location(section, file$2, 16, 0, 320);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(section, "consider", /*handleConsider*/ ctx[1], false, false, false),
    					listen_dev(section, "finalize", /*handleFinalize*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*items*/ 1) {
    				...
    				validate_each_keys(ctx, each_value, get_each_context$1, get_key);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, section, fix_and_destroy_block, create_each_block$1, null, get_each_context$1);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['items', 'onDrop'];
    	...
    	return [items, handleConsider, handleFinalize, onDrop];
    }

    class Buttons extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { items: 0, onDrop: 3 });
    		...
    		if (/*items*/ ctx[0] === undefined && !('items' in props)) {
    			console.warn("<Buttons> was created without expected prop 'items'");
    		}

    		if (/*onDrop*/ ctx[3] === undefined && !('onDrop' in props)) {
    			console.warn("<Buttons> was created without expected prop 'onDrop'");
    		}
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	buttons = new Buttons({
    			props: {
    				items: /*$config*/ ctx[1].services,
    				onDrop: /*handleDrop*/ ctx[2]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = space();
    			h32 = element("h3");
    			h32.textContent = "Buttons";
    			t16 = space();
    			create_component(buttons.$$.fragment);
    			add_location(h2, file$1, 21, 0, 479);
    			add_location(h30, file$1, 24, 4, 543);
    			add_location(input0, file$1, 25, 4, 562);
    			attr_dev(span0, "class", "confirm button svelte-cen74h");
    			add_location(span0, file$1, 26, 4, 604);
    			add_location(hr, file$1, 34, 4, 771);
    			add_location(h31, file$1, 36, 4, 805);
    			attr_dev(a, "href", "https://github.com/rvnpower/bnt/README.md#bg");
    			add_location(a, file$1, 37, 11, 842);
    			add_location(small, file$1, 37, 4, 835);
    			add_location(input1, file$1, 38, 4, 929);
    			attr_dev(span1, "class", "confirm button svelte-cen74h");
    			add_location(span1, file$1, 39, 4, 973);
    			add_location(h32, file$1, 48, 4, 1196);
    			attr_dev(div, "class", "settings svelte-cen74h");
    			add_location(div, file$1, 22, 0, 497);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*configTemp*/ ctx[0].title);
    			append_dev(div, t4);
    			...
    			set_input_value(input1, /*configTemp*/ ctx[0].bgPath);
    			append_dev(div, t12);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*configTemp*/ 1 && input0.value !== /*configTemp*/ ctx[0].title) {
    				set_input_value(input0, /*configTemp*/ ctx[0].title);
    			}

    			if (dirty & /*configTemp*/ 1 && input1.value !== /*configTemp*/ ctx[0].bgPath) {
    				set_input_value(input1, /*configTemp*/ ctx[0].bgPath);
    			}

    			const buttons_changes = {};
    			if (dirty & /*$config*/ 2) buttons_changes.items = /*$config*/ ctx[1].services;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleDrop(newItems) {
    		set_store_value(config, $config.services = newItems, $config);
    	}
    	...
    	function input0_input_handler() {
    		configTemp.title = this.value;
    		$$invalidate(0, configTemp);
    	}

    	const click_handler = () => {
    		set_store_value(config, $config.title = configTemp.title, $config);
    	};

    	function input1_input_handler() {
    		configTemp.bgPath = this.value;
    		$$invalidate(0, configTemp);
    	}

    	const click_handler_1 = () => {
    		set_store_value(config, $config.bgPath = checkBlank(configTemp.bgPath, "./assets/dark.png"), $config);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ('configTemp' in $$props) $$invalidate(0, configTemp = $$props.configTemp);
    	};
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "header flex-center svelte-vhh1pu");
    			add_location(div0, file, 23, 12, 848);
    			attr_dev(div1, "class", "services svelte-vhh1pu");
    ...
    // (29:16) {#each $config.services as service}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:16) {#each $config.services as service}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 18, 16, 668);
    			attr_dev(button, "class", "settingsBtn svelte-vhh1pu");
    			add_location(button, file, 17, 12, 577);
    			attr_dev(div0, "class", "settings svelte-vhh1pu");
    			add_location(div0, file, 16, 8, 542);
    			attr_dev(div1, "class", "interface svelte-vhh1pu");
    			add_location(div1, file, 14, 4, 451);
    			attr_dev(div2, "class", "container flex-center svelte-vhh1pu");
    			set_style(div2, "--bgPath", style___bgPath, false);
    			add_location(div2, file, 11, 0, 315);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => $$invalidate(0, settingsMode = !settingsMode);
    	...
    	return [settingsMode, $config, click_handler];
    }
